...
def product_list(request):
    ...
    return render(request, 'shop/product_list.html', {
        ...
        'categories': categories,
        'manufacturers': manufacturers
    }) #открываем страницу списка товаров каталога детского мира в папке shop по заданию третьего пункта
...
def update_cart(request, item_id):
    ...
    return render(request, 'shop/cart.html', {'cart': cart, 'error_message': error_message}) #открываем страницу корзины в папке shop с переданной ошибкой
...
def cart_view(request):
    ...
    return render(request, 'shop/cart.html', {'cart': cart}) #отображение всех элементов корзины с общей стоимостью по заданию четвертого пункта

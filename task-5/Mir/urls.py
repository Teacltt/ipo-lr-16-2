...
# Параметр basename для корректной фильтрации get_queryset (Задание 3, Пункт 4)
...
urlpatterns = [
    ...
    # Визуальная страница личного кабинета (Задание 4)
    path('profile/', views.profile_page_view, name='profile_page'),
    
    # Новый REST API эндпоинт профиля текущей сессии (Задание 3)
